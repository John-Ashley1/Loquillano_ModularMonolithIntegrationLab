...
> _Add your screenshots here before submitting._ Save images under
> `docs/screenshots/` and embed with `![...](docs/screenshots/your-file.png)`.

**Multi-item order — all succeed:**
`[screenshot placeholder]`

**Multi-item order — one item rejected, no partial reservation:**
`[screenshot placeholder]`
